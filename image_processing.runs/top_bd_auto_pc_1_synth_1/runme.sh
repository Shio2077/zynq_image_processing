...
HD_PWD='D:/Projects/prj/AMD/image_processing/image_processing.runs/top_bd_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bd_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bd_auto_pc_1.tcl
