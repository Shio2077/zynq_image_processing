...
HD_PWD='D:/Projects/prj/AMD/image_processing/image_processing.runs/top_bd_v_axi4s_vid_out_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bd_v_axi4s_vid_out_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bd_v_axi4s_vid_out_0_0.tcl
